...
(function (toolkit) {
    ...
    var Provider = (function () {
        ...
        Provider.prototype.refresh = function (callback) {
            var self = this;
            this.dataSource.fetch(this.getCriteria(), function (result) {
    ...
    // initialize form
    function showModal(id, show, onClose) {
        var modal = $(id);
        if (show) {
