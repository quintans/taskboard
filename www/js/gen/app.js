...
;
angular.module("taskboard", ["ngRoute", "remoteServices", "ngStorage"]).config(function ($httpProvider) {
    ...
    function ping() {
        taskBoardService.ping(function () {
            $rootScope.$broadcast(EVENT_LOGIN_OK);
        });
    }
    ;
